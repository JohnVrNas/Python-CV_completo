import random
print(' ')
print('\033[1;34mVocê é um mero andarilho, desbravando as terras de Py em busca de novas aventuras e conhecimentos, \ncarregando consigo somente uma poção de cura e uma espada enferrujada e cansada de tantas batalhas, \nde repente você avista o espírito da preguiça e procrastinação, determinado a derrotá-lo para continuar \nsua incansável busca, você saca sua arma e parte para o ataque!\033[m')
...
while player > 0 and monstro > 0:
    input('\033[1;35m Digite atq para desferir um golpe:\033[m').strip()
